...
AddFlatWithImageUseCase injectAddFlatWithImageUseCase() {
  return AddFlatWithImageUseCase(flatRepoContract: injectFlatRepoContract());
}

FlatRepoContract injectFlatRepoContract() {
  return FlatRepoImpl(flatDataSourceContract: injectFlatDataSourceContract());
}

FlatDataSourceContract injectFlatDataSourceContract() {
  return FlatSupabaseDataSourceImpl(
