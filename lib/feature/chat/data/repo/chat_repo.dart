...
abstract class ChatRepo {
  ...
  Future<void> sendMessage({required String message, required String senderId, required String receiverId});
  Future<List<MessageModel>> getMessages({required String user1Id,required String user2Id});
